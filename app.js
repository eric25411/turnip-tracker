document.addEventListener("DOMContentLoaded", () => {
  ...
  // Safety checks so the script does not silently die
  if (!predictView || !historyView) {
    console.log("Missing predictView or historyView in HTML.");
    return;
  }
  if (!navPredict || !navHistory) {
    console.log("Missing navPredict or navHistory in HTML. Check the ids in your bottom nav.");
    return;
  }
  if (!saveWeekBtn) {
    console.log("Missing saveWeekBtn in HTML.");
    return;
  }
  if (!historyList || !historyEmptyNote) {
    console.log("Missing historyList or historyEmptyNote in HTML.");
    return;
  }
